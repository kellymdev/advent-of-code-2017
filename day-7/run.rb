require_relative 'program_towers'
...
# Part 1
towers = ProgramTowers.new(input)
bottom_tower = towers.find_bottom_tower
towers.print_bottom_tower(bottom_tower)

# Part 2
unbalanced = ProgramTowers.new(input)
disc = unbalanced.find_unbalanced_tower
unbalanced.print_unbalanced_disc(disc)
